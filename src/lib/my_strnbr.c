/*
** my_strnbr.c for mysh in /home/pirou_g/minishell2/src
** 
** Made by Guillaume Pirou
** Login   <pirou_g@epitech.net>
** 
** Started on  Sun Feb  1 08:36:22 2015 Guillaume Pirou
** Last update Fri May 15 21:04:04 2015 guigui
*/
...
char	*my_strnbr(int nbr, char *base)
{
  ...
  if (nbr < 0)
    ...
    {
      tab = gbgc_malloc(NULL, sizeof(tab) * my_countnb_b(nbr, my_strlen(base)));
      if (tab == NULL)
	return (NULL);

/*
** listes2.c for mysh in /home/pirou_g/PSU_2014_minishell2/src
** 
** Made by Guillaume Pirou
** Login   <pirou_g@epitech.net>
** 
** Started on  Sun Mar  8 17:09:44 2015 Guillaume Pirou
** Last update Fri May 15 20:59:54 2015 guigui
*/
...
t_mls	*createlist(void *data, void (*set_data)(t_mls *, const void *))
{
  t_mls *n_el;
...
int	list_addel(t_mls *lst, void *data,
		   void (*set_data)(t_mls *, const void *))
{
  t_mls	*el;
